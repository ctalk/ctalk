/* $Id: ctypes-cygwin.c,v 1.1.1.1 2019/10/26 23:40:51 rkiesling Exp $ */
/*
...
#include <float.h>
#ifdef __DJGPP__
#  warning "inttypes.h is not implemented."
#else
#  warning "inttypes.h."
#  include <inttypes.h>
#endif
...
#include <signal.h>
#ifdef __DJGPP__
#  warning "Not testing stdarg.h (defines in stdio.h)."
#else
#  warning "stdarg.h."
#  include <stdarg.h>
#endif
...
#include <stdbool.h>
#ifdef __DJGPP__
#  warning "Not testing stddef.h (defines in stdio.h)."
#else
#  warning "stddef.h."
#  include <stddef.h> 
#endif
#if defined(__DJGPP__) || defined(__sun__)
...
#warning "string.h."
#include <string.h> 
#ifndef __GNUC__     /* GCC does not support tgmath.h on all platforms. */
#warning "tgmath.h."
#include <tgmath.h>
#endif
#warning "time.h."
...
int main (int argc, char **argv) {
  ...
  printf ("\"\'c\' + longIntA + intA\" evaluates to: %d.\n",
	  'c' + longIntA + intA);

  printf ("\"longIntA + \'d\'+ intA\" evaluates to: %d.\n",
	  longIntA + 'd' + intA);

  printf ("\"longIntA + intA + \'e\'\" evaluates to: %d.\n",
	  longIntA + intA + 'e');
